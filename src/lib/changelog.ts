...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date: '2026-09-09',
    items: [
      '中文读评分全自动：不再显示四个手动评分按钮（A/S/D/F 快捷键同时停用）。第一遍读对自动判「熟练」，第一遍读错自动判「略陌生」，都会自动进入下一个词。',
      '读错后点「听正确读音」不再被自动切换打断：播放（含辅助词）结束前不进入下一个词，播完稍作停留再自动继续。',
      '读对的烟花庆祝特效更大、持续更久。',
      '去掉中文读「点一下麦克风，读出上面的内容」提示文字。',
      '修复「发音评估结果无效」「语音合成结果无效」问题；评估遇到上游限流或跨境网络失败时自动退避并重试（建连超时压缩到 5 秒、最多 5 次尝试，界面会显示诊断码），读错后准备正确读音的速度大幅加快。',
    ],
  },
  {
    version: 'v2.0.0',
    date: '2026-08-22',
    items: [
      '中文读新增麦克风发音练习：首次读对判「熟练」并播放庆祝动画，首次读错判「彻底陌生」，支持重试、标准读音和单字三组辅助词，且中文读关闭倒计时。',
      '发音服务升级为同步中文 ASR 加原始录音复核：只有高置信度的明确结论才评分，过短或听不清的录音直接重试；同时增加登录校验、跨实例限流，并让标准读音顺序预取保留成功缓存。',
